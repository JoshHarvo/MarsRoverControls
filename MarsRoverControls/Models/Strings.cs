namespace MarsRoverControls.Models
{
    public class Strings
    {
        ...
        internal string Introduction0() 
            ...
            $"It is waiting for your command at coordinate ({_data.RoverCoordinate[1]}, {_data.RoverCoordinate[0]}) and is currently facing {_data.Direction}.\n" +
        ...
        internal static string AwaitCommandIntroduction { get; } = "Enter your first command...\n\n";
        ...
        internal string Boundary()
            ...
            $"At coordinate ({_data.RoverCoordinate[1]},{_data.RoverCoordinate[0]}).\n" +
            "Please turn the rover if you wish to move again.\n";
        
        internal string GiveCoordinate()
            => $"The the Rover is currently at coordinate ({_data.RoverCoordinate[1]},{_data.RoverCoordinate[0]}) and is facing {_data.Direction}.\n";
